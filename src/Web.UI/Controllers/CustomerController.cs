...
namespace Web.UI.Controllers
{
    ...
    public class CustomerController : BaseController
    {
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var custumerViewModel = await _customerAppService.GetById(id.Value);

            if (custumerViewModel == null) return NotFound();
        ...
        public async Task<IActionResult> Edit(CustomerViewModel customerViewModel)
        {
            ...
            ViewBag.Sucesso = "Custumer Updated!";
            return View(customerViewModel);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            ViewBag.Sucesso = "Custumer Removed!";
            return RedirectToAction("Index");
        }

        [AllowAnonymous]
        [HttpGet("customer-management/custmer-history/{id:guid}")]
